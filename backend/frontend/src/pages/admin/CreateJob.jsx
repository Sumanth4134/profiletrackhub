    ...
    <div className="dashboard-shell premium-jobs-shell">
      ...
      <div className="dashboard-heading-row jobs-heading-block">
        <div>
          ...
          <h1 className="dashboard-page-title">{isSuperAdmin ? 'Super Admin Job Workspace' : 'Recruiter Job Workspace'}</h1>
          <p className="dashboard-page-copy mb-0">
            Create job posts with secure public apply links that only expose the selected vacancy.
          </p>
        </div>
      </div>
